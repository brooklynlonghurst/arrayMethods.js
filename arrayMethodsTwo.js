...
// CODE HERE
 //.map putting it into a new array
...
// CODE HERE
  //make new array citiesThatEndWithI 
  //use .filter method on cities to loop through 
...
fruits.forEach((fruit) => {
  if(fruit.color === "red"){
    return console.log(`The fruit that ends with index ${fruits.indexOf(fruit)} is an apple.`)
  } else if(fruit.color === "orange"){
    return console.log(`The fruit that ends with index ${fruits.indexOf(fruit)} is an orange.`)
  } else {
    console.log(`The fruit that ends with index ${fruits.indexOf(fruit)} is neither apple nor orange.`)
  }
})
...
// The fruit that ends with index 0 is neither apple nor orange.
// The fruit that ends with index 1 is an orange.
// The fruit that ends with index 2 is neither apple nor orange.
// The fruit that ends with index 3 is an apple.
